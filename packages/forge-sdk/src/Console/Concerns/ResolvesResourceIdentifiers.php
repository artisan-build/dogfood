...
trait ResolvesResourceIdentifiers
{
     ...
     */
    protected function resolveServerId(string|int $identifier, string $organization, ForgeSdk $forge): int
    {
     ...
     */
    protected function resolveOrganizationSlug(string|int $identifier, ForgeSdk $forge): string
    {
     ...
     * Resolve a server identifier (name or ID) to a server ID.
     */
    protected function resolveServerIdentifier(string|int $identifier, string $organization, ForgeSdk $forge): int
    {
     ...
     */
    protected function resolveSiteIdentifier(string|int $identifier, string $organization, string|int $server, ForgeSdk $forge): int
    {
        // If numeric or int, assume it's an ID
        if (is_int($identifier) || is_numeric($identifier)) {
            return (int) $identifier;

...
test('embedding manager stores embedding with synchronized IDs', function () {
...
test('embedding manager validates vector dimensions', function () {
    $manager = new EmbeddingManager;
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
...
test('embedding manager updates existing embedding', function () {
    $manager = new EmbeddingManager;
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
...
test('embedding manager deletes embeddings for model', function () {
    $manager = new EmbeddingManager;
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
...
test('embedding manager retrieves embeddings for model', function () {
    $manager = new EmbeddingManager;
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
...
test('embedding manager stores batch embeddings', function () {
    $manager = new EmbeddingManager;
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
...
test('embedding manager handles custom dimensions', function () {
...
test('embedding manager accepts model name as string', function () {
    $manager = new EmbeddingManager;
    $vector = array_fill(0, 1536, 0.1);

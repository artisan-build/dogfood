...
test('embeddings are stored on configured connection not model connection', function () {
...
test('polymorphic relationships work across connections', function () {
    // Create article on PRIMARY connection
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
...
test('search works with cross-connection setup', function () {
    // Create article on PRIMARY connection
    $article = new class extends Illuminate\Database\Eloquent\Model
    {
        protected $table = 'articles';
    ...
    $builder = new ArtisanBuild\SqliteVector\SearchQueryBuilder($queryVector);
...
test('migrations create tables on configured connection', function () {

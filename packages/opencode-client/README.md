<p align="center"><img src="https://github.com/artisan-build/opencode-client/raw/HEAD/art/opencode-client.png" width="75%" alt="Artisan Build Package Opencode Client Logo"></p>
...
`composer require artisan-build/opencode-client`

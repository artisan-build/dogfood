---
source: https://forge.laravel.com/docs/api-reference/roles/create-role.md
fetched: 2025-10-19T14:38:38.070Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi post /orgs/{organization}/roles
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/CreateRoleRequest'
            requiredProperties:
              - name
        examples:
          example:

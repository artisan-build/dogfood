---
source: https://forge.laravel.com/docs/api-reference/organizations/list-organizations.md
fetched: 2025-10-19T14:37:06.914Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs
paths:
  path: /orgs
  method: get
  servers:

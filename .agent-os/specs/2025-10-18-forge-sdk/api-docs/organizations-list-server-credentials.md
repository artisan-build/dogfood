---
source: https://forge.laravel.com/docs/api-reference/organizations/list-server-credentials.md
fetched: 2025-10-19T14:37:11.696Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/server-credentials
paths:
  path: /orgs/{organization}/server-credentials
  method: get
  servers:

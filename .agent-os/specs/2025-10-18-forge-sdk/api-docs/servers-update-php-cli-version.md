---
source: https://forge.laravel.com/docs/api-reference/servers/update-php-cli-version.md
fetched: 2025-10-19T14:40:18.895Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi put /orgs/{organization}/servers/{server}/php/cli-version
paths:

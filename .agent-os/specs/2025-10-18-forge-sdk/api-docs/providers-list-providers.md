---
source: https://forge.laravel.com/docs/api-reference/providers/list-providers.md
fetched: 2025-10-19T14:37:24.121Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /providers
paths:
  path: /providers
  method: get
  servers:

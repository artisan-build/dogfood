---
source: https://forge.laravel.com/docs/api-reference/recipes/get-recipe.md
fetched: 2025-10-19T14:37:48.964Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/recipes/{recipe}
paths:

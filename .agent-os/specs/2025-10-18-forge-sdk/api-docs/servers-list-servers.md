---
source: https://forge.laravel.com/docs/api-reference/servers/list-servers.md
fetched: 2025-10-19T14:39:32.806Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers
paths:
      ...
      query:
        sort:
          schema:
            - type: string
              description: >-
                Available sorts are `name`, `provider`, `ubuntu_version`,
                `region`, `php_version`, `created_at`, `updated_at`. You can

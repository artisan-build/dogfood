---
source: https://forge.laravel.com/docs/api-reference/sites/list-sites-for-organization.md
fetched: 2025-10-19T14:41:19.141Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/sites
paths:
  path: /orgs/{organization}/sites
  method: get
  servers:

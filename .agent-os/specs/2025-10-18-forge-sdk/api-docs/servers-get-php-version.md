---
source: https://forge.laravel.com/docs/api-reference/servers/get-php-version.md
fetched: 2025-10-19T14:40:29.690Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/php/versions/{phpVersion}
paths:

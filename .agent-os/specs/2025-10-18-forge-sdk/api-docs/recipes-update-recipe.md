---
source: https://forge.laravel.com/docs/api-reference/recipes/update-recipe.md
fetched: 2025-10-19T14:37:51.473Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi put /orgs/{organization}/recipes/{recipe}
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/UpdateRecipeRequest'
        examples:
          example:
            value:
              name: <string>

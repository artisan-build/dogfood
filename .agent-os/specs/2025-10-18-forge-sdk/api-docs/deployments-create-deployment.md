---
source: https://forge.laravel.com/docs/api-reference/deployments/create-deployment.md
fetched: 2025-10-19T14:35:19.145Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi post /orgs/{organization}/servers/{server}/sites/{site}/deployments
paths:

---
source: https://forge.laravel.com/docs/api-reference/nginx/update-nginx-template.md
fetched: 2025-10-19T14:37:02.701Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi put /orgs/{organization}/servers/{server}/nginx/templates/{nginxTemplate}
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/UpdateNginxTemplateRequest'
            requiredProperties:
              - name
              - content
        examples:

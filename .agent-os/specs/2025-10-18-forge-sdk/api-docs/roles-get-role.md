---
source: https://forge.laravel.com/docs/api-reference/roles/get-role.md
fetched: 2025-10-19T14:38:40.354Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/roles/{role}
paths:

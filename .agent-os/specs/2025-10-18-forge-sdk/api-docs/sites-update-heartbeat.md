---
source: https://forge.laravel.com/docs/api-reference/sites/update-heartbeat.md
fetched: 2025-10-19T14:42:48.691Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi put /orgs/{organization}/servers/{server}/sites/{site}/heartbeats/{heartbeat}
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/UpdateHeartbeatRequest'
            requiredProperties:
              - name
              - grace_period
              - frequency

---
source: https://forge.laravel.com/docs/api-reference/integrations/get-laravel-horizon-integration-status.md
fetched: 2025-10-19T14:35:55.904Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/sites/{site}/integrations/horizon
paths:
  path: /orgs/{organization}/servers/{server}/sites/{site}/integrations/horizon
  method: get
  servers:

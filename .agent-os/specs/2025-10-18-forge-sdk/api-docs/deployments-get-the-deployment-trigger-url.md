---
source: https://forge.laravel.com/docs/api-reference/deployments/get-the-deployment-trigger-url.md
fetched: 2025-10-19T14:35:31.484Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/sites/{site}/deployments/deploy-hook
paths:

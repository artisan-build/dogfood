---
source: https://forge.laravel.com/docs/api-reference/ssh-keys/update-server-public-ssh-key.md
fetched: 2025-10-19T14:39:00.506Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi put /orgs/{organization}/servers/{server}/key
paths:

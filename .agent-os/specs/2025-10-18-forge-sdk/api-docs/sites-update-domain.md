---
source: https://forge.laravel.com/docs/api-reference/sites/update-domain.md
fetched: 2025-10-19T14:41:42.114Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi patch /orgs/{organization}/servers/{server}/sites/{site}/domains/{domainRecord}
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/UpdateDomainRequest'
            requiredProperties:
              - www_redirect_type
        examples:
          example:

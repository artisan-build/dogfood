---
source: https://forge.laravel.com/docs/api-reference/commands/list-commands.md
fetched: 2025-10-19T14:34:28.852Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/sites/{site}/commands
paths:
  path: /orgs/{organization}/servers/{server}/sites/{site}/commands
  method: get
  servers:
      ...
      query:
        sort:
          schema:
            - type: string
              description: >-
                Available sorts are `status`, `created_at`, `updated_at`. You
                can sort by multiple options by separating them with a comma. To

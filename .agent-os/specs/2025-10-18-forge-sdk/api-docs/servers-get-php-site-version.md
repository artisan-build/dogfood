---
source: https://forge.laravel.com/docs/api-reference/servers/get-php-site-version.md
fetched: 2025-10-19T14:40:21.096Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/php/site-version
paths:

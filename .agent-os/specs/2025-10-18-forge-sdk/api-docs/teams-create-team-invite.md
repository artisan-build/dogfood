---
source: https://forge.laravel.com/docs/api-reference/teams/create-team-invite.md
fetched: 2025-10-19T14:43:17.256Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi post /orgs/{organization}/teams/{team}/invites
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/CreateTeamInviteRequest'
            requiredProperties:
              - role_id
              - email
        examples:

---
source: https://forge.laravel.com/docs/api-reference/servers/get-server.md
fetched: 2025-10-19T14:40:03.716Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}
paths:

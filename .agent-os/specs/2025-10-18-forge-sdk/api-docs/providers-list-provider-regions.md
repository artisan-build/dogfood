---
source: https://forge.laravel.com/docs/api-reference/providers/list-provider-regions.md
fetched: 2025-10-19T14:37:33.976Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /providers/{provider}/regions
paths:
  path: /providers/{provider}/regions
  method: get
  servers:

---
source: https://forge.laravel.com/docs/api-reference/servers/get-server-php-max-execution-time.md
fetched: 2025-10-19T14:40:57.074Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/php/max-execution-time
paths:

---
source: https://forge.laravel.com/docs/api-reference/nginx/list-nginx-templates.md
fetched: 2025-10-19T14:36:55.440Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /orgs/{organization}/servers/{server}/nginx/templates
paths:
  path: /orgs/{organization}/servers/{server}/nginx/templates
  method: get
  servers:
      ...
      query:
        sort:
          schema:
            - type: string
              description: >-
                Available sorts are `created_at`, `updated_at`, `name`. You can

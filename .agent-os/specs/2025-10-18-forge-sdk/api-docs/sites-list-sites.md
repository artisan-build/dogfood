---
source: https://forge.laravel.com/docs/api-reference/sites/list-sites.md
fetched: 2025-10-19T14:41:17.022Z
---
...
````yaml https://forge.laravel.com/api/docs.openapi get /sites
paths:
  path: /sites
  method: get
  servers:
